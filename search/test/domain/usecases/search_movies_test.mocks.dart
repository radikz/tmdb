...
import 'package:core/movie/domain/entities/movie.dart' as _i6;
import 'package:core/search/domain/repositories/search_repository.dart' as _i3;
...
class MockSearchRepository extends _i1.Mock implements _i3.SearchRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i7.Tv>>> searchTvs(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchTvs,
          [query],
